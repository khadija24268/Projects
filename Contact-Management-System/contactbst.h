...
class ContactBST
{
	...
	public:
		...
		void update(Node* root_ptr, string key); 			//Edit the node with key
		void remove(Node* root_ptr,string key);				//Delete a node with key from the tree/subtree with root
